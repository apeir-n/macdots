...
alias toys="$HOME/.nursery/scripts/toybox.sh"
alias life="game_of_life"
alias o="cd $HOME/Library/Mobile\ Documents/iCloud~md~obsidian/Documents/Vault && y"
alias op="cd $HOME/Library/Mobile\ Documents/iCloud~md~obsidian/Documents/Vault/__planner && y"
